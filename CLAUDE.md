...
## Run Information
- Mayhem Run: mayhemheroes/vdexextractor/vdexextractor/2
- Git Commit: b90d1338f306618d877c0ca73bfdcf2b8c930ffe
- Original Image: ghcr.io/mayhemheroes/vdexextractor:master
- Target Executable: /vdexExtractor
- CI URL: https://github.com:443/mayhemheroes/vdexExtractor/actions/runs/2690061562
...
- Source code: `/rlenv/source/vdexextractor/`
...
RUN cp <build-artifact> /vdexExtractor

# 11. Permission Management (REQUIRED)
RUN chmod 766 /vdexExtractor
...
- `COPY . /rlenv/source/vdexextractor/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/vdexextractor/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /vdexExtractor`
...
- [ ] Target executable in Dockerfile.rlenv: `/vdexExtractor`
- [ ] Target executable in build.sh: `/vdexExtractor`
- [ ] Target executable in metadata.json: `/vdexExtractor`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/vdexextractor/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/vdexextractor/fuzz
...
- Source copy: `COPY . /rlenv/source/vdexextractor/`
...
- Working directory: `cd /rlenv/source/vdexextractor/`
- No network access
